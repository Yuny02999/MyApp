package com.example.myapplmh.draw;


import com.example.myapplmh.R;
...
public class DynamicLineChartManager {
    ...
    Entry entry;
    int mColors[] = {R.color.color1, R.color.color2,R.color.color3,R.color.color4};
    ...
    public void addEntry(float number) {
        ...
        entry = new Entry(lineDataSet.getEntryCount(), number);
    ...
    public void addEntry(List<Float> numbers) {
        ...
        for (int i = 0; i < numbers.size(); i++) {
            entry = new Entry( lineDataSet.getEntryCount(), numbers.get(i));
